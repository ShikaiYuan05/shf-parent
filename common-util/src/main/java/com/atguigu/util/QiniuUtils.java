...
public class QiniuUtils {
    private static String accessKey = "qHFxmIovZdBQDT31rhnSJ03r7Q-Phnzy4gE9WU-6";
    private static String secretKey = "YtXBvi0IiAvEY_agUweKBkIOl6942D-jFp4O3HAt";
    private static String bucket = "yuan05";
    ...
    public static String getUrl(String filePath) {
        return "http://rvix2gntt.hn-bkt.clouddn.com/" + filePath;
    }
}
